...
Examples:
    ...
    init_skill.py my-skill --path .agents/skills --interface short_description="Short UI label"
"""
...
**Note:** Scripts may be executed without loading into context, but can still be read by the
agent for patching or environment adjustments.
...
guides, or any detailed information that the agent should reference while working.
